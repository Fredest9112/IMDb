            ...
            bottomNavBottomNavigationView.setOnItemSelectedListener {
                when (it.itemId) {
                    R.id.home_icon_bnv -> {
                        ...
                        bottomNavBottomNavigationView.menu.findItem(R.id.home_icon_bnv).isChecked =
                            true
                    }
                    R.id.search_icon_bnv -> {
                        replaceFragment(SearchFragment())
                        bottomNavBottomNavigationView.menu.findItem(R.id.search_icon_bnv).isChecked =
                            true
                    }
                    R.id.play_icon_bnv -> {
                        replaceFragment(PlayFragment())
                        bottomNavBottomNavigationView.menu.findItem(R.id.play_icon_bnv).isChecked =
                            true
                    }
